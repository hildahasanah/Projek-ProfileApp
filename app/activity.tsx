...
const DEFAULT_ACTIVITIES: ActivityItemType[] = [
  ...
  { time: "08.00", title: "Bersih-Bersih", icon: "brush-outline" },
  { time: "12.00", title: "Istirahat", icon: "cafe-outline" },
  { time: "13.00", title: "Mengerjakan Tugas", icon: "laptop-outline" },
  { time: "16.00", title: "Berangkat Kuliah", icon: "bus-outline" },
  { time: "18.20", title: "Belajar", icon: "book-outline" },
  { time: "22.00", title: "Pulang", icon: "home-outline" },
  { time: "00.00", title: "Tidur", icon: "moon-outline" },
];
