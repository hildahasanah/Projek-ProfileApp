...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Modal, TextInput, KeyboardAvoidingView, Platform, Alert, Image, Linking } from "react-native";
...
export default function ProfileTabScreen() {
  ...
  const [profile, setProfile] = useState({
    ...
    email: "hilda.hasanah@example.com",
    nohp: "+62 812-3456-7890",
    ttl: "Tangerang, 1 Januari 2004",
    tentang: "Saya adalah mahasiswa aktif di Universitas Yatsi Madani yang antusias terhadap pengembangan teknologi. Saya memiliki minat besar dalam pembuatan aplikasi mobile dan web."
  });

  const [skills, setSkills] = useState<string[]>(["React Native", "JavaScript", "TypeScript", "HTML", "CSS", "PHP", "Laravel", "Python", "Git"]);
  ...
  return (
    ...
    >
      <SafeAreaView style={styles.container} edges={["bottom"]}>
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.modalContent}>
              ...
              <ScrollView contentContainerStyle={styles.modalForm} showsVerticalScrollIndicator={false}>
                {[
                  ...
                  { label: "NIM", key: "nim", keyboardType: "numeric" },
        ...
        >
          <LinearGradient
            colors={["rgba(252, 228, 236, 0.92)", "rgba(227, 242, 253, 0.92)"]}
            style={styles.fullscreenOverlay}
          >
            <TouchableOpacity 
              style={styles.fullscreenOverlayTouch} 
              activeOpacity={1} 
            ...
            >
              <TouchableOpacity 
                ...
                onPress={() => setIsAvatarPreviewVisible(false)}
              >
                <Ionicons name="close" size={30} color="#e91e8c" />
              </TouchableOpacity>
              <View style={styles.fullscreenAvatarRing}>
                <Image 
...
const styles = StyleSheet.create({
  ...
  scrollContent: { paddingTop: 195, paddingBottom: 85 }, // Tambah bottom padding agar tidak tertutup tab bar
  profileHeroCard: {
  ...
  fullscreenAvatarRing: {
    width: 260,
    height: 260,
    borderRadius: 130,
    borderWidth: 6,
    borderColor: "#f9a8d4", // Cincin/Garis merah muda
    padding: 4,
    backgroundColor: "#fff",
    ...Platform.select({
      ios: {
  ...
  fullscreenImage: {
    width: "100%",
    height: "100%",
    borderRadius: 120, // Membuat foto menjadi lingkaran di dalam ring
  },
});
